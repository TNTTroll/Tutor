...
public class KafkaConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> messageKafkaListenerContainerFactory() {
        ...
        factory.setConsumerFactory(tutorConsumerFactory());
        return factory;
    }

    @Bean
    public ConsumerFactory<String, String> tutorConsumerFactory() {
    ...
    @Bean
    KafkaTemplate<String, String> tutorKafkaTemplate() {
        KafkaTemplate<String, String> template = new KafkaTemplate<>(producerFactory());
        template.setConsumerFactory(tutorConsumerFactory());
        return template;
    }
}
